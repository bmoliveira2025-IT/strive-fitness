...
"C:\\Program Files\\Microsoft\\jdk-21.0.1.12-hotspot\\bin\\java" ^
  ...
  27 ^
  --output ^
  "C:\\Users\\braul\\AppData\\Local\\Temp\\agp-prefab-staging8849818514320353827\\staged-cli-output" ^
  ...
  "C:\\Users\\braul\\.gemini\\antigravity\\scratch\\gym_app\\mobile_app\\android\\app\\build\\intermediates\\cxx\\refs\\react-native-worklets\\4y2v1e5z" ^
