...
type SavedWorkoutsContextType = {
    ...
    commitWorkoutCompletion: (id: string, exercises?: SavedExercise[]) => Promise<void>;
...
export function SavedWorkoutsProvider({ children }: { children: ReactNode }) {
    ...
    const updateWorkout = (id: string, updates: Partial<SavedWorkout>) => {
    ...
    const commitWorkoutCompletion = async (id: string, exercises?: SavedExercise[]) => {
        ...
        await AsyncStorage.setItem(SAVED_WORKOUTS_KEY, JSON.stringify(nextWorkouts));
